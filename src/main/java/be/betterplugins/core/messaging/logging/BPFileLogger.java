...
public class BPFileLogger extends BPLogger
{
    ...
    /**
     * Provides the same functionality as BPlogger but will ALSO log to a file (all messages by default, even finest)
     ...
     */
    public BPFileLogger(Level logLevel, JavaPlugin plugin) throws IOException
    {
     ...
     */
    public BPFileLogger(Level logLevel, JavaPlugin plugin, String pluginName) throws IOException
    {
